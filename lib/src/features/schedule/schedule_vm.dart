...
class ScheduleVm extends _$ScheduleVm {
  ...
  Future<void> register({
    ...
    final scheduleResult = await scheduleRepository.scheduleCleint(dto);

    switch (scheduleResult) {
      case Success():
        state = state.copyWith(state: ScheduleStateStatus.success);
      case Failure():
        state = state.copyWith(state: ScheduleStateStatus.error);
    }
